...
public class BorrowingReturning {
    /*
     * One label book borrows one label text box button Layered window Large panel Make bottom label button Add to the panel
     *
     */
    // Layer
    public JLayeredPane jLayeredPane = new JLayeredPane();
    // label
    private JLabel jLabel = new JLabel("Book borrow and return");
    private JLabel jLabel2 = new JLabel("Book id: ");
    private JLabel jLabel3 = new JLabel("Book name: ");
    private JLabel jLabel4 = new JLabel();
    private JLabel jLabel5 = new JLabel("Author: ");
    private JLabel jLabel6 = new JLabel();
    private JLabel jLabel7 = new JLabel("Statement: ");
    private JLabel jLabel8 = new JLabel();
    private JLabel jLabel9 = new JLabel("Book id: ");
    ...
    private Font font2 = new Font("Dialog", Font.BOLD, 30);
    private Font font3 = new Font("Dialog", Font.BOLD, 26);
    ...
    public BorrowingReturning() {
        ...
        // labels and button on the panel
    ...
    private void addEvent() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!flag) {
                            JOptionPane.showMessageDialog(null, "book does not exist", "Warning!", JOptionPane.WARNING_MESSAGE);
                            empty();
                        }
                        con.close();
        ...
        button3.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (jLabel8.getText().equals("In store")) {
                    id = Integer.parseInt(jLabel10.getText().trim());
                    BorrowRecords.Borrow(user, id, jLabel4.getText().trim());
                    JOptionPane.showMessageDialog(null, "borrow successfully", "Congratulation!", JOptionPane.WARNING_MESSAGE);
                    empty();
                    model.setRowCount(0);
                    FindBook.allbook(model);
                } else if (jLabel8.getText().equals("has been borrowed")) {
                    JOptionPane.showMessageDialog(null, "this book has been borrowed", "Warning!", JOptionPane.WARNING_MESSAGE);
                    empty();
                } else {
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // TODO Auto-generated method stub
                if (jLabel8.getText().equals("has been borrowed")) {
                    if(BorrowRecords.comparison(user, id)) {
                        ...
                        JOptionPane.showMessageDialog(null, "this book is not your borrowed", "Warning!", JOptionPane.WARNING_MESSAGE);
                    }
                } else if (jLabel8.getText().equals("In store")) {
                    JOptionPane.showMessageDialog(null, "this book is in store", "Warning!", JOptionPane.WARNING_MESSAGE);
                    empty();
                } else {
                    JOptionPane.showMessageDialog(null, "Error!", "Warning!", JOptionPane.WARNING_MESSAGE);
                }

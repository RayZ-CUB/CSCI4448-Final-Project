...
public class Category {
    ...
    public static boolean addcategory(String category) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Category already Exists!", "Warning", JOptionPane.WARNING_MESSAGE);
            return false;
        }
    }
    //Edit category
    public static boolean setcategory(String category,String category2) {
        ...
        try {
            ...
            con.close();
            if(ok==0) {
                JOptionPane.showMessageDialog(null, "Category does not Exist", "Warning!", JOptionPane.WARNING_MESSAGE);
                return false;
            }
            return true;
        } catch (SQLException e) {
